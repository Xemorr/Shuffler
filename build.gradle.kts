...
dependencies {
    ...
    shadow("io.github.revxrsal:lamp.common:4.0.0-rc.17")
    shadow("io.github.revxrsal:lamp.bukkit:4.0.0-rc.17")
...
tasks.shadowJar {
    ...
    relocate("it.unimi.dsi", "me.xemor.shuffler.libs.fastutil")
